...
CREATE DATABASE
IF NOT EXISTS album DEFAULT CHARSET = utf8;
USE album;
...
INSERT INTO track (id, album_id, title, track_number, duration) VALUES (10,1,'That\'s All',10,368);
    ...
    VALUES
      (19, 11, 'Sgt. Pepper\'
    s Lonely Hearts Club Band',6,76);
...
INSERT INTO track (id, album_id, title, track_number, duration) VALUES (23,12,'Norwegian Wood
    (This Bird Has Flown)',2,125);
...
INSERT INTO track (id, album_id, title, track_number, duration) VALUES (34,12,'
    If I Needed Someone',13,143);
...
INSERT INTO track (id, album_id, title, track_number, duration) VALUES (45,13,'
    Open Country Joy
    ',9,236);
